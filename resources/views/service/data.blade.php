                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="full team_blog_colum">
                                <div class="it_team_img"> <img class="img-responsive" src="{{asset('images/it_service/team-member-1.jpg')}}" alt="#"> </div>
                        ...
                        <div class="col-md-4">
                            <div class="full team_blog_colum">
                                <div class="it_team_img"> <img class="img-responsive" src="{{asset('images/it_service/team-member-1.jp')}}" alt="#"> </div>
                                <div class="team_feature_head">
                                    <h4>Ruby Jake</h4>
                                </div>
                                <div class="team_feature_social">
                        ...
                        <div class="col-md-4">
                            <div class="full team_blog_colum">
                                <div class="it_team_img"> <img class="img-responsive" src="{{asset('images/it_service/team-member-3.jpg')}}" alt="#"> </div>
                                <div class="team_feature_head">
                                    <h4>David Hussay</h4>
                                </div>
                                <div class="team_feature_social">
                ...
                <div class="col-md-3">
                    <div class="side_bar">
                        ...
                        <div class="side_bar_blog">
                            ...
                            <a class="btn sqaure_bt" href="it_service.html">Get a Quote!</a> </div>
                        <div class="side_bar_blog">
                            <h4>OUR SERVICE</h4>
                            <div class="categary">
                                <ul>
